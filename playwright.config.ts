...
export default defineConfig({
 ...
 webServer:{command:'node server/index.mjs',url:'http://127.0.0.1:47834/api/health',reuseExistingServer:false,env:{PHYSIS_PORT:'47834',PHYSIS_DATA_DIR:'/tmp/physis-browser-test-library',PHYSIS_TEST_MODE:'1'}}
});
