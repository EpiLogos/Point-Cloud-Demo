...
function projectNativeConfig(s:Scene):PointCloudConfig{
 ...
 cfg.depth={...DEFAULT_DEPTH_CONFIG,...cfg.depth,projection:s.engine.depthPerspective===true?'perspective':'orthographic',occlusion:s.engine.depthOcclusion===true,depthTintColor:s.engine.depthTintColor??cfg.depth?.depthTintColor??DEFAULT_DEPTH_CONFIG.depthTintColor};
 cfg.fluid={...cfg.fluid,vortex3d:s.engine.vortex3d??cfg.fluid.vortex3d??0,dispersion3d:s.engine.dispersion3d??cfg.fluid.dispersion3d??0};
