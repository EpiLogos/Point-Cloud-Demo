...
with browser_session({'width':640,'height':480}) as (_,ctx,page):
    ...
    report={'reference':'63e650d26a04447b973f73dded6b5046a0829e84','results':results,'browserErrors':errors,'environment':'Same Chromium software WebGL context/device, controlled 512-particle native fixtures. Geometry float32 budget 0.00013, position and velocity 0.00025 native units over four steps.'}
